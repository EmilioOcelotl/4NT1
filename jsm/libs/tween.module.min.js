...
let e=Object.keys(this._tweens); if (0===e.length) return !1; for (t=void 0!==t?t:TWEEN.now(); 0<e.length;) {
this._tweensAddedDuringUpdate={}; for (let i=0; i<e.length; i++) {
let r=this._tweens[e[i]]; r&&!1===r.update(t)&&(r._isPlaying=!1, n||delete this._tweens[e[i]]);
...
let t=process.hrtime(); return 1e3*t[0]+t[1]/1e6;
...
for (let n in this._group.add(this), this._isPlaying=!0, this._onStartCallbackFired=!1, this._startTime=void 0!==t?'string'==typeof t?TWEEN.now()+parseFloat(t):t:TWEEN.now(), this._startTime+=this._delayTime, this._valuesEnd) {
...
for (let t=0, n=this._chainedTweens.length; t<n; t++) this._chainedTweens[t].stop();
}, group: function(t) {
...
let n, e, i; if (t<this._startTime) return !0; for (n in !1===this._onStartCallbackFired&&(null!==this._onStartCallback&&this._onStartCallback(this._object), this._onStartCallbackFired=!0), e=(t-this._startTime)/this._duration, e=0===this._duration||1<e?1:e, i=this._easingFunction(e), this._valuesEnd) {
if (void 0!==this._valuesStart[n]) {
let r=this._valuesStart[n]||0, a=this._valuesEnd[n]; a instanceof Array?this._object[n]=this._interpolationFunction(a, i):('string'==typeof a&&(a='+'===a.charAt(0)||'-'===a.charAt(0)?r+parseFloat(a):parseFloat(a)), 'number'==typeof a&&(this._object[n]=r+(a-r)*i));
}
...
let s=this._valuesStartRepeat[n]; this._valuesStartRepeat[n]=this._valuesEnd[n], this._valuesEnd[n]=s;
...
}null!==this._onCompleteCallback&&this._onCompleteCallback(this._object); for (let o=0, u=this._chainedTweens.length; o<u; o++) this._chainedTweens[o].start(this._startTime+this._duration); return !1;
...
let n=2.5949095; return (t*=2)<1?t*t*((1+n)*t-n)*.5:.5*((t-=2)*t*((1+n)*t+n)+2);
...
let e=t.length-1, i=e*n, r=Math.floor(i), a=TWEEN.Interpolation.Utils.Linear; return n<0?a(t[0], t[1], i):1<n?a(t[e], t[e-1], e-i):a(t[r], t[e<r+1?e:r+1], i-r);
}, Bezier: function(t, n) {
...
let e=t.length-1, i=e*n, r=Math.floor(i), a=TWEEN.Interpolation.Utils.CatmullRom; return t[0]===t[e]?(n<0&&(r=Math.floor(i=e*(1+n))), a(t[(r-1+e)%e], t[r], t[(r+1)%e], t[(r+2)%e], i-r)):n<0?t[0]-(a(t[0], t[0], t[1], t[1], -i)-t[0]):1<n?t[e]-(a(t[e], t[e], t[e-1], t[e-1], i-e)-t[e]):a(t[r?r-1:0], t[r], t[e<r+1?e:r+1], t[e<r+2?e:r+2], i-r);
}, Utils: {Linear: function(t, n, e) {
return (n-t)*e+t;
}, Bernstein: function(t, n) {
let e=TWEEN.Interpolation.Utils.Factorial; return e(t)/e(n)/e(t-n);
}, Factorial: function() {
let i=[1]; return function(t) {
let n=1; if (i[t]) return i[t]; for (let e=t; 1<e; e--)n*=e; return i[t]=n;
};
}(), CatmullRom: function(t, n, e, i, r) {
let a=.5*(e-t), s=.5*(i-n), o=r*r; return (2*n-2*e+a+s)*(r*o)+(-3*n+3*e-2*a-s)*o+a*r+n;
}}}, function(t) {
