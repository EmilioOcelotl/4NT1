...
import * as tfjsWasm from '@tensorflow/tfjs-backend-wasm'; // Esto podría irse? ya no es opción OB

import {TRIANGULATION} from './triangulation'; // Qué es esto 

tfjsWasm.setWasmPaths(
    `https://cdn.jsdelivr.net/npm/@tensorflow/tfjs-backend-wasm@${tfjsWasm.version_wasm}/dist/`); // Esto también podría irse 
